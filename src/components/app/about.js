    ...
    return (
      <React.Fragment>
          <Segment basic inverted onClick={() => this.toggleDetails()} as={'div'} className={'about-component rave-component'} >
            <Header as={'h3'} style={{fontFamily: "'Inconsolata', monospace"}}><em>Color Guide</em> <Icon name='chevron right' style={{float: 'right', transition: 'ease-in .1s', color: 'white'}} rotated={this.state.active ? 'clockwise' : null}/></Header>
